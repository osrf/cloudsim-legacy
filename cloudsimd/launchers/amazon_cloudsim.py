...
def acquire_aws_server(constellation_name,  credentials_ec2, constellation_directory, tags):
...
def launch(username, configuration, constellation_name, tags, 
    ...
    sim_ip, simulation_aws_id = acquire_aws_server(constellation_name, credentials_ec2,sim_machine_dir, tags)
