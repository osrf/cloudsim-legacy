...
Vagrant.configure("2") do |config|
  ...
  # precise64.vm.network :forwarded_port, guest: 80, host: 8080
  ...
  # your network.
  # precise64.vm.network :public_network

  # Share an additional folder to the guest VM. The first argument is
  # the path on the host to the actual folder. The second argument is
  # the path on the guest to mount the folder. And the optional third
  # argument is a set of non-required options.
  # precise64.vm.synced_folder "../data", "/vagrant_data"
  ...
  #
  # precise64.vm.provision :chef_solo do |chef|
  ...
  #
  # precise64.vm.provision :chef_client do |chef|
