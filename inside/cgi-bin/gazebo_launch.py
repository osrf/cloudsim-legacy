...
print("Package name (e.g., pr2_gazebo):")
print("<input type=\"text\" name=\"package\"/><br>")
print("Launch file name (e.g., pr2_empty_world.launch):")
print("<input type=\"text\" name=\"launchfile\"/><br>")
