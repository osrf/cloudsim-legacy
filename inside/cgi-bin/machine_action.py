...
print("<p>Are you sure that you want to %s this machine (%s)?</p>"%(action, machine_id))
if action == 'terminate':
    print("<p><font color=\"red\">Warning</font>: if the machine is still being created, then terminating now may cause it to be orphaned, and will require administrator intervention for cleanup.</p>")
...
print("</form>")
print("<form action=\"/cloudsim/inside/cgi-bin/console.py\" method=\"GET\">")
